...
class RankedItemConverter(private val context: Context) {
    ...
    fun transform(topItem: RankingEntity, titleType: TitleType): com.g.pocketmal.ui.legacy.viewmodel.RankedItemViewModel {
        ...
        return com.g.pocketmal.ui.legacy.viewmodel.RankedItemViewModel(
            topItem.id,
            topItem.title,
            topItem.mainPicture,
            members,
    ...
    fun transform(topItems: List<RankingEntity>, titleType: TitleType): List<com.g.pocketmal.ui.legacy.viewmodel.RankedItemViewModel> {
