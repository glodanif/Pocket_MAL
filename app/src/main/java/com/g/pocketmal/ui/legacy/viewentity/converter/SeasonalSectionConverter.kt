...
class SeasonalSectionConverter(private val converter: SeasonalAnimeConverter) {
    ...
    fun transform(items: List<SeasonEntity>, season: Season): List<com.g.pocketmal.ui.legacy.viewentity.SeasonalSectionViewModel> {
        ...
        return sectionsList.map {item ->
            com.g.pocketmal.ui.legacy.viewentity.SeasonalSectionViewModel(
                item.title,
