...
class SearchResultConverter(private val context: Context) {
    ...
    fun transform(item: SearchEntity, titleType: TitleType): SearchResultViewModel {
    ...
    fun transform(items: List<SearchEntity>, titleType: TitleType): List<SearchResultViewModel> {
