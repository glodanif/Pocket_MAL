...
class SeasonalAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private var seasonalList: List<SeasonalSectionViewModel> = ArrayList()

    var listener: ((SeasonalAnimeViewModel) -> Unit)? = null
    ...
    fun setItems(seasonalList: List<SeasonalSectionViewModel>?) {
    ...
    private fun bindTitle(holder: ItemViewHolder, title: SeasonalAnimeViewModel) {
