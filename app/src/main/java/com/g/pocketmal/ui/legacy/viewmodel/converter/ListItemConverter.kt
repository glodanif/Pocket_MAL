...
class ListItemConverter(private val context: Context) {
    ...
    fun transform(record: DbListRecord): com.g.pocketmal.ui.legacy.viewmodel.RecordViewModel {
        ...
        return com.g.pocketmal.ui.legacy.viewmodel.RecordViewModel(
    ...
    fun transform(records: List<DbListRecord>): List<com.g.pocketmal.ui.legacy.viewmodel.RecordViewModel> {
        return records.map { transform(it) }
    }

    fun createFrame(id: Int, type: TitleType): com.g.pocketmal.ui.legacy.viewmodel.RecordViewModel {
        return createFrame(id, type, null)
    }

    fun createFrame(id: Int, type: TitleType, detailsViewModel: com.g.pocketmal.ui.legacy.viewmodel.TitleDetailsViewModel?): com.g.pocketmal.ui.legacy.viewmodel.RecordViewModel {
