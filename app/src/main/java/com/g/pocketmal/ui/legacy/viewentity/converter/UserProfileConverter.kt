...
class UserProfileConverter {
    ...
    fun transform(entity: UserProfileEntity): com.g.pocketmal.ui.legacy.viewentity.UserProfileViewModel {
        ...
        return com.g.pocketmal.ui.legacy.viewentity.UserProfileViewModel(
            entity.id,
            entity.name,
            entity.avatar,
            genderDrawable,
