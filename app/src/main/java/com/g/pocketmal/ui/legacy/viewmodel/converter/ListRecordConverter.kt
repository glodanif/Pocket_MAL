...
class ListRecordConverter(private val context: Context) {
    ...
    fun transform(titleType: TitleType, record: DbListRecord, useEnglishTitle: Boolean): com.g.pocketmal.ui.legacy.viewmodel.RecordListViewModel {

        val isAnime = titleType == TitleType.ANIME

        return com.g.pocketmal.ui.legacy.viewmodel.RecordListViewModel(
    ...
    fun transform(titleType: TitleType, records: List<DbListRecord>, useEnglishTitle: Boolean): List<com.g.pocketmal.ui.legacy.viewmodel.RecordListViewModel> {

        val viewModels = ArrayList<com.g.pocketmal.ui.legacy.viewmodel.RecordListViewModel>()
