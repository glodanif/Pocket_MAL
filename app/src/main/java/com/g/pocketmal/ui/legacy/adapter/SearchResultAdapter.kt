...
class SearchResultAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private val searchResult = ArrayList<com.g.pocketmal.ui.legacy.viewmodel.SearchResultViewModel>()
    ...
    fun addItems(searchResult: List<com.g.pocketmal.ui.legacy.viewmodel.SearchResultViewModel>) {
        this.searchResult.addAll(searchResult)
    }

    fun setItems(searchResult: List<com.g.pocketmal.ui.legacy.viewmodel.SearchResultViewModel>) {
