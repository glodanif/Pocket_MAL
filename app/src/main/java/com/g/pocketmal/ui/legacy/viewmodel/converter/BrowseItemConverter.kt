...
class BrowseItemConverter(private val context: Context) {
    ...
    fun transform(topItem: RankingEntity): com.g.pocketmal.ui.legacy.viewmodel.BrowseItemViewModel {
        ...
        return com.g.pocketmal.ui.legacy.viewmodel.BrowseItemViewModel(
            topItem.id,
            topItem.title,
            topItem.mainPicture,
            mediaTypeLabel,
    ...
    fun transform(topItems: List<RankingEntity>): List<com.g.pocketmal.ui.legacy.viewmodel.BrowseItemViewModel> {
