...
class EditDetailsPresenter(
    ...
    private val view: EditDetailsView,
    private val route: EditDetailsRoute,
    ...
    private var previousState: EditDetailsView.State? = null

    fun restoreState(state: EditDetailsView.State) {
