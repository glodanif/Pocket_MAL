...
class SeasonalAnimeConverter {
    ...
    fun transform(item: SeasonEntity): com.g.pocketmal.ui.legacy.viewentity.SeasonalAnimeViewModel {
        ...
        return com.g.pocketmal.ui.legacy.viewentity.SeasonalAnimeViewModel(
            item.id,
            item.title,
            item.picture?.large,
            info,
    ...
    fun transform(items: List<SeasonEntity>): List<com.g.pocketmal.ui.legacy.viewentity.SeasonalAnimeViewModel> {
