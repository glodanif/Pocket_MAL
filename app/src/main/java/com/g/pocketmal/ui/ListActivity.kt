...
class ListActivity : SkeletonToolbarActivity(), ListView, ListRoute {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drawerLayout?.let { layout ->
            drawerToggle = object : ActionBarDrawerToggle(this, layout, toolbar, R.string.app_name, R.string.app_name) {
