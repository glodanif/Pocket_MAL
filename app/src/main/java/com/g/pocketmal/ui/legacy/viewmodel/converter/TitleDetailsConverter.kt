...
class TitleDetailsConverter(private val context: Context) {
    ...
    fun transform(details: TitleDetailsTable): com.g.pocketmal.ui.legacy.viewmodel.TitleDetailsViewModel {
        ...
        return com.g.pocketmal.ui.legacy.viewmodel.TitleDetailsViewModel(
            details.id,
            details.titleType,
    ...
    fun transform(details: List<TitleDetailsTable>): List<com.g.pocketmal.ui.legacy.viewmodel.TitleDetailsViewModel> {
        val viewModels: MutableList<com.g.pocketmal.ui.legacy.viewmodel.TitleDetailsViewModel> = ArrayList()
        for (item in details) {
