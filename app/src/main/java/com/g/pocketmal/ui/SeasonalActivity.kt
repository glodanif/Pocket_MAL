...
class SeasonalActivity : SkeletonToolbarActivity(), SeasonalView, SeasonalRoute {
    ...
    override fun displayFailPopup() {
        if (!isFinishing && !isDestroyed) {
            snackBar = Snackbar.make(seasonalList, R.string.seasonal__fail, Snackbar.LENGTH_INDEFINITE)
