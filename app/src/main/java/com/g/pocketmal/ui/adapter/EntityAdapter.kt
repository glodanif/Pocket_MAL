...
class EntityAdapter(private val context: SkeletonActivity, titles: List<RecordListViewModel>? = ArrayList()) : BaseAdapter() {

    var originalTitles: List<RecordListViewModel>
    var currentTitles: List<RecordListViewModel>
    ...
    fun setCurrentList(data: List<RecordListViewModel>) {
        this.currentTitles = data
    }

    fun setOriginalList(data: List<RecordListViewModel>) {
        setCurrentList(data)
        this.originalTitles = ArrayList<RecordListViewModel>(data)
    }
