...
class ListStatsFragment : Fragment() {
    ...
    private var userData: UserProfileViewModel? = null
    ...
    fun setUserData(userData: UserProfileViewModel, type: TitleType) {
        ...
        val items = ArrayList<MultiProgressBar.ProgressItem>()
        items.add(MultiProgressBar.ProgressItem(0,
                counts.inProgressCount, resources.getColor(R.color.in_progress_graph)))
        items.add(MultiProgressBar.ProgressItem(1,
                counts.completedCount, resources.getColor(R.color.completed_graph)))
        items.add(MultiProgressBar.ProgressItem(2,
                counts.onHoldCount, resources.getColor(R.color.on_hold_graph)))
        items.add(MultiProgressBar.ProgressItem(3,
                counts.droppedCount, resources.getColor(R.color.dropped_graph)))
        items.add(MultiProgressBar.ProgressItem(4,
