...
class SharingPatternDispatcher(private val context: Context) {
    ...
    private val animeRewatchedPattern: String
        get() = preferences.getString(
            KEY_ANIME_REWATCHED,
            context.getString(R.string.rewatchedAnime)
        )
            ?: ""
    ...
    private val animeEpisodesWithEpisodesPattern: String
        get() = preferences
            .getString(
                KEY_ANIME_EPISODES_WITH_EPISODES,
                context.getString(R.string.watchingWithSeriesEpisodesAnime)
            )
            ?: ""
    ...
    private val animeStartedWatchingFromEpisodePattern: String
        get() = preferences
            .getString(
                KEY_ANIME_STARTED_FROM_EPISODE,
                context.getString(R.string.resumedToWatchAnime)
            )
            ?: ""
    ...
    private val animeCompletedWithScorePattern: String
        get() = preferences
            .getString(
                KEY_ANIME_COMPLETED_WITH_SCORE,
                context.getString(R.string.completedWithScoreAnime)
            )
            ?: ""
    ...
    private val mangaChaptersWithChaptersPattern: String
        get() = preferences
            .getString(
                KEY_MANGA_CHAPTERS_WITH_CHAPTERS,
                context.getString(R.string.readingChapterWithSeriesChapterManga)
            )
            ?: ""
    ...
    private val mangaVolumesWithVolumesPattern: String
        get() = preferences
            .getString(
                KEY_MANGA_VOLUMES_WITH_VOLUMES,
                context.getString(R.string.readingVolumesWithSeriesVolumesManga)
            )
            ?: ""
    ...
    private val mangaStartedReadingFromChapterPattern: String
        get() = preferences
            .getString(
                KEY_MANGA_STARTED_FROM_CHAPTER,
                context.getString(R.string.resumedToReadChaptersManga)
            )
            ?: ""
    ...
    private val mangaStartedReadingFromVolumePattern: String
        get() = preferences
            .getString(
                KEY_MANGA_STARTED_FROM_VOLUME,
                context.getString(R.string.resumedToReadVolumesManga)
            )
            ?: ""
    ...
    private val mangaCompletedWithScorePattern: String
        get() = preferences
            .getString(
                KEY_MANGA_COMPLETED_WITH_SCORE,
                context.getString(R.string.completedWithScoreManga)
            )
            ?: ""
    ...
    private fun getPattersList(type: TitleType): List<SharingPattern> {
        ...
        if (type === TitleType.ANIME) {
            patterns.add(
                cretePattern(
                    KEY_ANIME_RATED,
                    R.string.sharing_pattern__name_rated,
                    R.string.ratedAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_REWATCHED,
                    R.string.sharing_pattern__name_rewatched,
                    R.string.rewatchedAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_STARTED,
                    R.string.sharing_pattern__name_started,
                    R.string.startedToWatchAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_STARTED_FROM_EPISODE,
                    R.string.sharing_pattern__name_started_from_episode,
                    R.string.resumedToWatchAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_EPISODES,
                    R.string.sharing_pattern__name_watched,
                    R.string.watchingAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_EPISODES_WITH_EPISODES,
                    R.string.sharing_pattern__name_watched_with_episodes,
                    R.string.watchingWithSeriesEpisodesAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_COMPLETED,
                    R.string.sharing_pattern__name_completed,
                    R.string.completedAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_COMPLETED_WITH_SCORE,
                    R.string.sharing_pattern__name_completed_and_scored,
                    R.string.completedWithScoreAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_ON_HOLD,
                    R.string.sharing_pattern__name_on_hold,
                    R.string.onHoldAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_DROPPED,
                    R.string.sharing_pattern__name_dropped,
                    R.string.droppedAnime
                )
            )
            patterns.add(
                cretePattern(
                    KEY_ANIME_PLANNED,
                    R.string.sharing_pattern__name_planned,
                    R.string.planToWatchAnime
                )
            )
        } else {
            patterns.add(
            ...
            patterns.add(
                cretePattern(
                    KEY_MANGA_REREAD,
                    R.string.sharing_pattern__name_reread,
                    R.string.rereadManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_STARTED,
                    R.string.sharing_pattern__name_started,
                    R.string.startedToReadManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_STARTED_FROM_CHAPTER,
                    R.string.sharing_pattern__name_started_from_chapter,
                    R.string.resumedToReadChaptersManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_STARTED_FROM_VOLUME,
                    R.string.sharing_pattern__name_started_from_volume,
                    R.string.resumedToReadVolumesManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_CHAPTERS,
                    R.string.sharing_pattern__name_read_chapters,
                    R.string.readingChapterManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_CHAPTERS_WITH_CHAPTERS,
                    R.string.sharing_pattern__name_read_chapters_with_chapters,
                    R.string.readingChapterWithSeriesChapterManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_VOLUMES,
                    R.string.sharing_pattern__name_read_volumes,
                    R.string.readingVolumeManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_VOLUMES_WITH_VOLUMES,
                    R.string.sharing_pattern__name_read_volumes_with_volumes,
                    R.string.readingVolumesWithSeriesVolumesManga
                )
            )
            patterns.add(
                cretePattern(
            ...
            patterns.add(
                cretePattern(
                    KEY_MANGA_COMPLETED_WITH_SCORE,
                    R.string.sharing_pattern__name_completed_and_scored,
                    R.string.completedWithScoreManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_ON_HOLD,
                    R.string.sharing_pattern__name_on_hold,
                    R.string.onHoldManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_ON_HOLD_VOLUMES,
                    R.string.sharing_pattern__name_on_hold_with_volumes,
                    R.string.onHoldVolumesManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_DROPPED,
                    R.string.sharing_pattern__name_dropped,
                    R.string.droppedManga
                )
            )
            patterns.add(
                cretePattern(
                    KEY_MANGA_DROPPED_VOLUMES,
                    R.string.sharing_pattern__name_dropped_with_volumes,
                    R.string.droppedVolumesManga
                )
            )
            patterns.add(
                cretePattern(
    ...
    fun getPattern(
        ...
        return try {
            getFinalText(
                title, if (title.recordType === TitleType.ANIME)
    ...
    class SharingPattern internal constructor(
        val key: String,
        val name: String,
