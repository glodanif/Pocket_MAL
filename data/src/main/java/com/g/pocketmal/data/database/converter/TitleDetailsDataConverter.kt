...
class TitleDetailsDataConverter {
    ...
    fun transform(details: TitleDetailsResponse, titleType: DataTitleType): TitleDetailsTable {
        ...
        return TitleDetailsTable(
            ...
            details.mediaType,
            details.status,
            if (titleType == DataTitleType.ANIME) details.numEpisodes else details.numChapters,
            if (titleType == DataTitleType.ANIME) 0 else details.numVolumes,
    ...
    fun transformToRecord(details: TitleDetailsResponse, titleType: DataTitleType): DbListRecord {

        val isAnime = titleType == DataTitleType.ANIME
